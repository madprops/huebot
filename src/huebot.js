...
Huebot.db.subjects = require(`${Huebot.files_path}subjects`)
		...
		try {
			...
			if (type === 'joined') {
				...
				if (Huebot.is_command(data.message)) {
					...
					Huebot.send_whisper(ctx, data.username, "Hi! I hope you like my drawing :)", Huebot.generate_random_drawing())
				}
